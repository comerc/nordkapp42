...
func (ec *executionContext) _Message_member(ctx context.Context, field graphql.CollectedField, obj *model.Message) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOMember2ᚖnordkapp42ᚋgraphᚋmodelᚐMember(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOMember2ᚖnordkapp42ᚋgraphᚋmodelᚐMember(ctx context.Context, sel ast.SelectionSet, v *model.Member) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
